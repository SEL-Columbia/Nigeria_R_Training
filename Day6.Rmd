...
```
<<<<<<< HEAD
 * Lets assume, again, that "skilled worker" is defined as: "nurses + doctors" if the facility offers c-section, and just "nurses" if the facility doesn't offer c-section. Using `ifelse`, define this (mock) indicator. The summary should match the following:
=======
